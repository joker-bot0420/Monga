...
def main():
    ...
    print(f"v2 train examples: {train_count}")
    print(f"v2 validation examples: {validation_count}")

    if train_count != 60:
        raise RuntimeError(f"Expected 60 v2 train examples, got {train_count}.")
    if validation_count != 12:
        raise RuntimeError(f"Expected 12 v2 validation examples, got {validation_count}.")
